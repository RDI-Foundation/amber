...
- `Component`: instance metadata (moniker path, manifest digest, config, config schema, program definition, slots, provides, named binding declarations, user-defined metadata).
