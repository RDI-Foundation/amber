...
from policy_lib import InterpositionJson, PolicyRequest, serve_policy
...
def build_interpositions(request: PolicyRequest) -> list[InterpositionJson]:
    return [
...
serve_policy(PORT, build_interpositions)
